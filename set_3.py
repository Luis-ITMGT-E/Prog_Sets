...
Original file is located at
    https://colab.research.google.com/drive/1HytsCdGVYSiknDB3nTQelBQ3WJ0_7628
"""
...
def tic_tac_toe(board):
    ...
    for col in range(n):
        symbol = board[0][col]
        if symbol != '' and all(board[row][col] == symbol for row in range(n)):
            return symbol
...
def eta(first_stop, second_stop, route_map):
    ...
    while current_stop != second_stop:
        for (start, end), data in route_map.items():
            ...
            raise ValueError("Invalid route map or unreachable stop")
